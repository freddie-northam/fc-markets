...
ALTER TABLE games
    ...
    USING released_at::timestamp AT TIME ZONE 'UTC';
...
INSERT INTO markets (id, game_id, platform)
SELECT v.id, g.id, v.platform
  FROM (VALUES
        ('0000fc26-0000-4000-8000-000000000010'::uuid, 'playstation'),
        ('0000fc26-0000-4000-8000-000000000011'::uuid, 'pc')
       ) AS v (id, platform)
  CROSS JOIN games g
 WHERE g.code = 'FC26'
